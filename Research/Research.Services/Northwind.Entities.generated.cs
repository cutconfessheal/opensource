...
namespace Research.Services.Northwind.NorthwindDataSetEntities
{
	...
	public class Order
	{
		...
		public System.Int32? EmployeeID
		{
			get
			{
				if(m_DataRow.IsNull("EmployeeID"))
					return null;
		...
		public System.DateTime? RequiredDate
		{
			get
			{
				if(m_DataRow.IsNull("RequiredDate"))
					return null;
		...
		public System.DateTime? ShippedDate
		{
			get
			{
				if(m_DataRow.IsNull("ShippedDate"))
					return null;
	...
	public class Product
	{
		...
		public System.Int32? SupplierID
		{
			get
			{
				if(m_DataRow.IsNull("SupplierID"))
					return null;
		...
		public System.Int32? CategoryID
		{
			get
			{
				if(m_DataRow.IsNull("CategoryID"))
					return null;
		...
		public System.Int16? UnitsInStock
		{
			get
			{
				if(m_DataRow.IsNull("UnitsInStock"))
					return null;
		...
		public System.Int16? UnitsOnOrder
		{
			get
			{
				if(m_DataRow.IsNull("UnitsOnOrder"))
					return null;
		...
		public System.Int16? ReorderLevel
		{
			get
			{
				if(m_DataRow.IsNull("ReorderLevel"))
					return null;
