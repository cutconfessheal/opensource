...
namespace Research.Services.Northwind.NorthwindDataSetRepositories
{
		...
		Research.Services.Northwind.NorthwindDataSetRepositories.ICategoryRepository
	{
		...
		public System.Int32 Insert(Research.Services.Northwind.NorthwindDataSetEntities.Category entity)
		{
			...
			return m_Adapter.Insert(row.CategoryName, row.Description, row.Picture);
		}
		...
		Research.Services.Northwind.NorthwindDataSetRepositories.ICustomerRepository
	{
		...
		{
			var row = entity.AsDataRow();
			return m_Adapter.Insert(row.CustomerID, row.CompanyName, row.ContactName, row.ContactTitle, row.Address, row.City, row.Region, row.PostalCode, row.Country, row.Phone, row.Fax);
		}
		...
		Research.Services.Northwind.NorthwindDataSetRepositories.IEmployeeRepository
	{
		...
		{
			var row = entity.AsDataRow();
			return m_Adapter.Insert(row.LastName, row.FirstName, row.Title, row.TitleOfCourtesy, row.BirthDate, row.HireDate, row.Address, row.City, row.Region, row.PostalCode, row.Country, row.HomePhone, row.Extension, row.Photo, row.Notes, row.ReportsTo, row.PhotoPath);
		}
		...
		Research.Services.Northwind.NorthwindDataSetRepositories.IOrderDetailRepository
	{
		...
		{
			var row = entity.AsDataRow();
			return m_Adapter.Insert(row.OrderID, row.ProductID, row.UnitPrice, row.Quantity, row.Discount);
		}
		...
		Research.Services.Northwind.NorthwindDataSetRepositories.IOrderRepository
	{
		...
		{
			var row = entity.AsDataRow();
			return m_Adapter.Insert(row.CustomerID, row.EmployeeID, row.OrderDate, row.RequiredDate, row.ShippedDate, row.ShipVia, row.Freight, row.ShipName, row.ShipAddress, row.ShipCity, row.ShipRegion, row.ShipPostalCode, row.ShipCountry);
		}
		...
		Research.Services.Northwind.NorthwindDataSetRepositories.IProductRepository
	{
		...
		{
			var row = entity.AsDataRow();
			return m_Adapter.Insert(row.ProductName, row.SupplierID, row.CategoryID, row.QuantityPerUnit, row.UnitPrice, row.UnitsInStock, row.UnitsOnOrder, row.ReorderLevel, row.Discontinued);
		}
		...
		Research.Services.Northwind.NorthwindDataSetRepositories.IShipperRepository
	{
		...
		{
			var row = entity.AsDataRow();
			return m_Adapter.Insert(row.CompanyName, row.Phone);
		}
		...
		Research.Services.Northwind.NorthwindDataSetRepositories.ISupplierRepository
	{
		...
		{
			var row = entity.AsDataRow();
			return m_Adapter.Insert(row.CompanyName, row.ContactName, row.ContactTitle, row.Address, row.City, row.Region, row.PostalCode, row.Country, row.Phone, row.Fax, row.HomePage);
		}
